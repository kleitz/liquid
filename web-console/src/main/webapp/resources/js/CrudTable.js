  ...
  render: function() {    
    return (
      <div className="form-group" key={this.props.key}>
        <label htmlFor={this.props.name} className="control-label"><FormattedMessage message={this.getIntlMessage(this.props.name)} /></label>
...
var ModalForm = React.createClass({
  ...
  render: function() {    
    ...
    for(var i = 0; i < this.props.fields.length; i++) {
      columns.push(this.props.fields[i])
      if(this.props.fields[i].type != 'hidden')
        counter++
      if(counter == width || i == this.props.fields.length - 1) {
...
var AddButton = React.createClass({
  ...
  handleClick: function() {
    $('#crudModalTitle').text(this.getIntlMessage('add') + this.getIntlMessage(this.props.modalTitle))
...
var UpdateButton = React.createClass({
  ...
  handleClick: function() {
    ...
    $('#crudModalTitle').text(this.getIntlMessage('update') + this.getIntlMessage(this.props.modalTitle))
  },
...
var TableRow = React.createClass({
  render: function() {
    ...
    cells.push(<td key='plus'><UpdateButton row={this.props.row} modalTitle={this.props.modalTitle} fields={this.props.fields} /></td>)  
...
var CrudTable = React.createClass({
  ...
  render: function() {
    ...
    heads.push(<th key='plus'><AddButton modalTitle={this.props.modalTitle} /></th>)

    var rows = [];
    this.props.data.forEach(function(row, index) {
      rows.push(<TableRow key={index} row={row} index={index} columns={component.props.columns} modalTitle={component.props.modalTitle} fields={component.props.fields} />);
    }) 
  
    rows.push(<SumRow data={this.props.data} />);
    rows.push(<DeductionRow data={this.props.data} />);
    ...
    return (
      <div>
        ...
        <ModalForm fields={this.props.fields} />
      </div>
    );
  }
})
